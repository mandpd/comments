...
You can also extract a specific note by providing a column vector of comment ids. A single comment will be printed
with only the comment text, unless the 'commentonly' paramter is set to false 
